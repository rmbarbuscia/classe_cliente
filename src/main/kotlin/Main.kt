...
// um construtor padrão e pelo menos mais duas opções
// de construtores conforme sua percepção, com os atributos: nome (String),
...
val Rodrigo = cliente("Rodrigo 123","Rua Gavivotas ", "(11)3544-7788")
